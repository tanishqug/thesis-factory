# Technical University of Munich (TUM) - Dissertation / Master Thesis Thesis Template
...
## Compliance Details
- **Font:** Arial (11pt)
- **Margins:** Top 1.0", Bottom 0.8", Left 1.0", Right 1.0"
- **Spacing:** 1.5 lines
...
- Title Page, - Abstract, - Zusammenfassung (German Abstract), - Table of Contents, - List of Figures, - List of Tables, - Abbreviations
