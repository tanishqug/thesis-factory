# Harvard University (FAS) - PhD Dissertation / Thesis Thesis Template (2026)

**File:** `Harvard_University_FAS_Thesis_Template_2026.docx`
...
While we strictly adhere to margin/font rules (1.5" L, 1.0" R), **ALWAYS** verify with your specific department before final submission.

## 🚀 Quick Start
1.  **Download** `Harvard_University_FAS_Thesis_Template_2026.docx`.
2.  **Open in Word**.
...
- [x] **Margins:** Top 1.0", Bottom 1.0", Left 1.5", Right 1.0"
