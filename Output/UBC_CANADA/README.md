# University of British Columbia (UBC) - Graduate Thesis Thesis Template (2026)

**File:** `University_of_British_Columbia_UBC_Thesis_Template_2026.docx`
...
While we strictly adhere to margin/font rules (1.25" L, 1.0" R), **ALWAYS** verify with your specific department before final submission.

## 🚀 Quick Start
1.  **Download** `University_of_British_Columbia_UBC_Thesis_Template_2026.docx`.
2.  **Open in Word**.
...
- [x] **Margins:** Top 1.0", Bottom 1.0", Left 1.25", Right 1.0"
- [x] **Line Spacing:** 2.0 lines
