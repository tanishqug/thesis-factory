# University of Oxford - DPhil / MSc / MLitt Thesis Template (2026)

**File:** `University_of_Oxford_Thesis_Template_2026.docx`
**Compliance:** 2026 Academic Guidelines
**Reference Style:** Oxford / Harvard
...
While we strictly adhere to margin/font rules (1.38" L, 1.0" R), **ALWAYS** verify with your specific department before final submission.

## 🚀 Quick Start
1.  **Download** `University_of_Oxford_Thesis_Template_2026.docx`.
2.  **Open in Word**.
...
- [x] **Margins:** Top 1.0", Bottom 1.0", Left 1.38", Right 1.0"
