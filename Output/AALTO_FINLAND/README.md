# Aalto University - Master's Thesis Thesis Template (2026)

**File:** `Aalto_University_Thesis_Template_2026.docx`
...
While we strictly adhere to margin/font rules (1.4" L, 1.0" R), **ALWAYS** verify with your specific department before final submission.

## 🚀 Quick Start
1.  **Download** `Aalto_University_Thesis_Template_2026.docx`.
2.  **Open in Word**.
...
- [x] **Font:** Arial (11pt)
- [x] **Margins:** Top 1.0", Bottom 1.0", Left 1.4", Right 1.0"
- [x] **Line Spacing:** 1.2 lines
